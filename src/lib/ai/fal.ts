  ...
  switch (concept) {
    ...
    case "global_storyboard":
      ...
      return [
        ...
        `- 1.0–2.5s · CUT 1 / ITALY (MILAN): a copper pan on a warm Italian stovetop holds a bubbling tomato pasta sauce. The pan contains ONLY the sauce — no spoon, no ladle, no utensil of any kind is visible. The product bottle enters from above and traces ONE smooth circular ring-pour, hovering alone over the pan. Quick cutaway to an Italian nonna's face glowing with delight, mouthing "Mamma mia..."`,
        `- 2.5–4.0s · CUT 2 / MEXICO (OAXACA): outdoor market kitchen, warm hand-painted color. A stone molcajete holds finished salsa verde — bowl shows ONLY the salsa, no pestle, no spoon visible. The product bottle enters alone and performs the SAME signature ring-pour over the salsa. Quick cutaway to a Mexican chef's smile, mouthing "¡Increíble!"`,
        `- 4.0–5.5s · CUT 3 / INDIA (MUMBAI): home kitchen, gold-warm spice tones. An earthen pot on the stove holds bubbling dal curry. The pot contains ONLY the curry — no ladle, no spoon visible. The product bottle enters alone and performs the SAME signature ring-pour. Quick cutaway to a woman in a sari beaming, mouthing "Wah!"`,
        `- 5.5–7.0s · CUT 4 / USA (BROOKLYN): rooftop BBQ, golden-hour rim light, brick wall in background. A grill holds sizzling burger patties — grill surface shows ONLY the patties, no brush, no spatula, no tongs visible. The product bottle enters alone and performs the SAME signature ring-pour over the patties. Quick cutaway to a Black man's satisfied smile, mouthing "Damn, that's good."`,
        `- 7.0–8.5s · CUT 5 / KOREA (SEOUL): bright home kitchen, warm fluorescent. An earthen pot holds bubbling kimchi jjigae — pot contains ONLY the stew, no spoon, no ladle visible. The product bottle enters alone and performs the SAME signature ring-pour. Quick cutaway to a child's bright thumbs-up, mouthing "와, 진짜 맛있어!"`,
