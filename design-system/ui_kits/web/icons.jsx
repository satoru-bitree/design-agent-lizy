...
const Icon = ({ name, size = 18, stroke = 1.5, className = '', style = {} }) => {
  ...
  switch (name) {
    case 'upload': return <svg {...props}><path d="M17.5 19a4.5 4.5 0 0 0 1.6-8.7 7 7 0 0 0-13.7-1.4A5 5 0 0 0 6 19"/><path d="M12 12v9"/><path d="m8 17 4-4 4 4"/></svg>;
    ...
    case 'sparkles': return <svg {...props}><path d="M12 3l1.91 5.5L19 10l-5.09 1.5L12 17l-1.91-5.5L5 10l5.09-1.5z"/></svg>;
    case 'palette': return <svg {...props}><circle cx="13.5" cy="6.5" r="1.5"/><circle cx="17.5" cy="10.5" r="1.5"/><circle cx="8.5" cy="7.5" r="1.5"/><circle cx="6.5" cy="12.5" r="1.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2"/></svg>;
    case 'chart': return <svg {...props}><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>;
    case 'package': return <svg {...props}><path d="M16.5 9.4 7.55 4.24"/><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>;
    ...
    case 'film': return <svg {...props}><rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M3 7.5h4"/><path d="M3 12h18"/><path d="M3 16.5h4"/><path d="M17 3v18"/><path d="M17 7.5h4"/><path d="M17 16.5h4"/></svg>;
